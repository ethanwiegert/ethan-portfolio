...
export function XIcon({ className = "size-5" }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.714-7.19-6.49 7.19H.75l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117Z" />
    </svg>
  );
}
